...
def create_user_teacherInfo(db: Session, teacherInfo: schemas.teacherInfoCreate, user_id: int):
    db_teacherInfo = models.teacherInfo(**teacherInfo.dict(), owner_id=user_id)
